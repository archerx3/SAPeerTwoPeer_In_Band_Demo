...
@implementation SAStatsBuilder
{
    ...
    // Bitrate trackers.
    SABitrateTracker *_audioRecvBitrateTracker;
    SABitrateTracker *_audioSendBitrateTracker;
    SABitrateTracker *_connRecvBitrateTracker;
    SABitrateTracker *_connSendBitrateTracker;
    SABitrateTracker *_videoRecvBitrateTracker;
    SABitrateTracker *_videoSendBitrateTracker;
}
...
- (instancetype)init
{
    if (self = [super init])
    {
        _audioSendBitrateTracker = [[SABitrateTracker alloc] init];
        _audioRecvBitrateTracker = [[SABitrateTracker alloc] init];
        _connSendBitrateTracker = [[SABitrateTracker alloc] init];
        _connRecvBitrateTracker = [[SABitrateTracker alloc] init];
        _videoSendBitrateTracker = [[SABitrateTracker alloc] init];
        _videoRecvBitrateTracker = [[SABitrateTracker alloc] init];
        _videoQPSum = 0;
        _framesEncoded = 0;
    }
    return self;
...
- (NSString *)statsString
{
    ...
    [result appendString:[NSString stringWithFormat:systemStatsFormat, (long)SAGetCpuUsagePercentage()]];
...
{
    [statsReport.values enumerateKeysAndObjectsUsingBlock:^(NSString *key, NSString *value, BOOL *stop) {
        
        if ([key isEqualToString:@"googAvailableSendBandwidth"])
        {
            _availableSendBw =
            [SABitrateTracker bitrateStringForBitrate:value.doubleValue];
        }
